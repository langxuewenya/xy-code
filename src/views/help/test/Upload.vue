<template>
  ...
  <div class="upload-wrap">
    <el-dialog title="文件管理" v-model="dialogVisible" :close-on-click-modal="false" custom-class="upload-dialog" :close-on-press-escape="false" @close="cancelFunc" :width="dialogWidth">
        ...
        <div class="file-type">
          <ul>
              ...
              <div class="operation" v-if="item.group_id!=null">
                ...
                <p @click.capture.stop="deleteCategoryFunc(item.group_id)">
          ...
          <ul class="fileContainerUI clearfix">
            <li class="file" v-for="(item, index) in fileList.data" :key="index" @click="selectFileFunc(item,index)">
              ...
              <div class="bottom-shade">
                <el-icon @click="deleteFileFunc(item)"><Delete /></el-icon>
              </div>
            </li>
          </ul>
        </div>
