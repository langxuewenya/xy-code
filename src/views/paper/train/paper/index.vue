  ...
  <div class="product-list">
    ...
    <div class="common-seach-wrap">
      <el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-form-item label="练习状态">
          <el-select size="small" v-model="searchForm.is_show" placeholder="练习状态">
    ...
    <div class="common-level-rail">
      <el-button size="small" type="primary" icon="Plus" @click="addClick" v-auth="'/paper/train/paper/add'">
        添加考试</el-button>
    </div>
    <!--内容-->
      ...
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="is_show" label="状态">
            <template  #default="scope">
              <el-switch v-model="scope.row.is_show" :active-value="0" :inactive-value="1" @change="catSet($event, scope.row.paper_id)"></el-switch>
            </template>
          </el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="150">
            <template  #default="scope">
              <el-button @click="editClick(scope.row)" type="text" size="small" v-auth="'/paper/train/paper/edit'">
                编辑考试
              </el-button>
              <el-button @click="delClick(scope.row)" type="text" size="small" v-auth="'/paper/train/paper/delete'">
                删除考试</el-button>
            </template>
          </el-table-column>
        </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        self.loading = true;
        PaperApi.trainPaperList(Params, true)
          .then(data => {
            self.loading = false;
