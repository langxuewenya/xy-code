<template>
  ...
  <div class="pb50" v-loading="loading">
    ...
    <div class="product-content"> 
      ...
      <div class="common-form mt16">成绩单</div>
      <el-form class="grade" :inline="true">
        <el-row justify="space-between">
          <div>
            <el-form-item label="得分">{{ detail.score }}</el-form-item>
            <el-form-item label="总分">{{ detail.paper && detail.paper.total_score }}</el-form-item>
          </div>
          <div>
            <el-form-item label="答对题数">{{ detail.right_question }}</el-form-item>
            <el-form-item label="总题数">{{ detail.wrong_question }}</el-form-item>
          </div>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    /* renderAnalysis(base64) {
      return `<img src="data:image/png;base64,${base64}" />`;
    }, */
    // 获取答题详情数据
    getAnswerDetails() {
      let self = this;
      PaperApi.examRecordQuestion({
