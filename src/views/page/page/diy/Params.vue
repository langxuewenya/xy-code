	...
	<div id="diy-editor" ref="diy-editor" class="diy-editor form-horizontal">
		<template v-if="form.curItem">
			...
			<template v-if="form.curItem.type == 'exam'">
				<ExamIndex :curItem="form.curItem" :selectedIndex="form.selectedIndex"></ExamIndex>
			</template>
			<!--标题-->
		...
		<!--练习列表弹出层-->
		<ExamSelect :isExam="isExam" :excludeIds="excludeIds" :islist="islist"
			@closeDialog="closeExamDialogFunc($event)">
			练习列表弹出层</ExamSelect>
		<!--练习列表弹出层-->
...
<script>
	...
	import ExamIndex from './params/Exam.vue';
	...
	import ExamSelect from '@/components/exam/exam.vue';
