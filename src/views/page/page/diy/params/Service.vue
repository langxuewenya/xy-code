<template>
	...
	<div>
		...
		<el-form size="small" :model="curItem" label-width="100px">
			...
			<!--不透明度-->
			<el-form-item label="不透明度："><el-slider v-model="curItem.style.opacity"
					show-input></el-slider></el-form-item>
			<!--客服类型-->
			<el-form-item label="客服类型：">
				<el-radio-group v-model="curItem.params.type">
					...
					<el-radio :label="'wx'">微信小程序客服</el-radio>
				</el-radio-group>
			</el-form-item>
			...
			<el-form-item label="客服图标：">
				<div class="diy-service-icon">
					<img v-img-url="curItem.params.image" alt=""
						@click="$parent.onEditorSelectImage(curItem.params, 'image')">
				</div>
				<div>建议尺寸90×90</div>
			</el-form-item>
		</el-form>
