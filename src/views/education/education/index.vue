	...
	<div class="product-list">
		...
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				...
				<el-form-item label="教务名称"><el-input size="small" v-model="searchForm.search"
		...
		<div class="common-level-rail"><el-button size="small" type="primary" icon="Plus" @click="addClick"
				v-auth="'/education/education/add'">添加教务</el-button></div>
		<!--内容-->
					...
					<el-table-column fixed="right" label="操作" width="150">
						<template #default="scope">
							<el-button @click="editClick(scope.row)" type="text" size="small"
								v-auth="'/education/education/edit'">编辑</el-button>
							<el-button @click="sectionClick(scope.row)" type="text" size="small"
								v-auth="'/education/education/detail'">详情</el-button>
							<el-button @click="delClick(scope.row)" type="text" size="small"
								v-auth="'/education/education/delete'">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
			</div>
