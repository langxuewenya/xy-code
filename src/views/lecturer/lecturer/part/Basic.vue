<template>
	<div>
		...
		<el-form-item v-if="form.model.scene=='add'" label="登录密码" prop="model.password"
			:rules="[{ required: true, message: ' ' }]">
			<el-input v-model="form.model.password" placeholder="请输入登录密码" type="password" class="max-w460"></el-input>
		</el-form-item>
		<el-form-item v-if="form.model.scene=='add'" label="确认密码" prop="model.confirm_password"
			:rules="[{ required: true, message: ' ' }]">
			<el-input v-model="form.model.confirm_password" placeholder="请输入确认密码" type="password"
				class="max-w460"></el-input>
		</el-form-item>
		<el-form-item v-if="form.model.scene=='edit'" label="登录密码" prop="model.password">
			<el-input v-model="form.model.password" placeholder="请输入登录密码" type="password" class="max-w460"></el-input>
		</el-form-item>
		<el-form-item v-if="form.model.scene=='edit'" label="确认密码" prop="model.confirm_password">
			<el-input v-model="form.model.confirm_password" placeholder="请输入确认密码" type="password"
				class="max-w460"></el-input>
		</el-form-item>
		<el-form-item label="简介："><el-input type="textarea" rows="6" v-model="form.model.describe"
		...
		<el-form-item label="标签：" :rules="[{ required: true, message: '请填写标签' }]" prop="model.label">
			...
			<el-input class="input-new-tag" v-if="inputVisible" maxlength="4" v-model="inputValue" ref="saveTagInput"
				size="small" @keyup.enter.native="handleInputConfirm" @blur="handleInputConfirm"></el-input>
			<el-button v-else-if="form.model.label.length < 3" class="button-new-tag" size="small" @click="showInput">+
				添加</el-button>
		</el-form-item>
		...
		<el-form-item label="首页推荐：" prop="model.is_top">
			<el-radio-group v-model="form.model.is_top">
		...
		<el-form-item label="账号禁用：" prop="model.is_forbid">
			<el-radio-group v-model="form.model.is_forbid">
				<el-radio :label="0">否</el-radio>
				<el-radio :label="1">是</el-radio>
			</el-radio-group>
		</el-form-item>
