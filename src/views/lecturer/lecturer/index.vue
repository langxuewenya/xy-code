		...
		<div class="product-content">
			<div class="table-wrap">
				<el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
					<el-table-column prop="lecturer_id" label="ID"></el-table-column>
					...
					<el-table-column prop="image" label="讲师封面">
						<template #default="scope">
							<div class="product-info">
								<div class="pic"><img v-img-url="scope.row.image_id!=0?scope.row.image.file_path:''"
										alt="" /></div>
							</div>
						</template>
					</el-table-column>
					<el-table-column prop="course_count" label="课程数量"></el-table-column>
					<el-table-column prop="real_browse" label="浏览数量"></el-table-column>
					...
					<el-table-column prop="is_forbid" label="账号状态">
						<template #default="scope">
							<el-switch v-model="scope.row.is_forbid" :active-value="0" :inactive-value="1"
								@change="forbidSet($event,scope.row.lecturer_id)">
							</el-switch>
						</template>
					</el-table-column>
