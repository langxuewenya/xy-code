<template>
	<div>
		...
		<el-form-item label="会员收费方式：" prop="model.member_pay" v-if="form.model.is_pay == 1">
			<el-radio-group v-model="form.model.member_pay">
				<el-radio :label="0">免费</el-radio>
				<el-radio :label="1">付费</el-radio>
			</el-radio-group>
		</el-form-item>
		<el-form-item :rules="rules.member_price" v-if="form.model.is_pay == 1&&form.model.member_pay == 1" label="会员价格：" prop="model.member_price">
