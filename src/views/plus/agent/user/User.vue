  ...
  <div class="user">
    <div class="common-seach-wrap">
      <el-form size="small" :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button size="small" type="primary" icon="Plus" @click="addClick" v-auth="'/plus/agent/user/add'">新增</el-button>
        </el-form-item>
      </el-form>
    </div>
        ...
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="nickName" label="微信头像" width="70">
            <template #default="scope">
              <img class="radius" v-if="scope.row.user" v-img-url="scope.row.user.avatarUrl" :width="30" :height="30" />
            </template>
          </el-table-column>
