<template>
	...
	<div class="">
		...
		<div class="poster-box d-s-s" v-loading="loading">
			<div class="left-box">
				<div v-if="form.backdrop" class=""><img v-img-url="form.backdrop.src" /></div>
				<div class="userinfo">
					<div
						class="photo pa"
			...
			<div class="right-box flex-1">
				<el-form size="small" ref="form" :model="form" label-width="200px">
					...
					<el-form-item label="二维码宽度 " prop="qrcode.width" :rules="[{ required: true, message: ' ' }]">
					...
					<!--用户头像横向距离-->
					<el-form-item label="用户头像横向距离">
						<el-slider class="max-w460" v-model="form.avatar.left" :max="375" size="small" show-input :show-input-controls="false" input-size="small"></el-slider>
					</el-form-item>
					<!--用户头像纵向距离-->
					<el-form-item label="用户头像纵向距离">
						<el-slider class="max-w460" v-model="form.avatar.top" :max="667" size="small" show-input :show-input-controls="false" input-size="small"></el-slider>
					</el-form-item>
					<!--用户昵称横向距离-->
					<el-form-item label="用户昵称横向距离">
						<el-slider class="max-w460" v-model="form.nickName.left" :max="375" size="small" show-input :show-input-controls="false" input-size="small"></el-slider>
					</el-form-item>
					<!--用户昵称纵向距离-->
					<el-form-item label="用户昵称纵向距离">
						<el-slider class="max-w460" v-model="form.nickName.top" :max="667" size="small" show-input :show-input-controls="false" input-size="small"></el-slider>
					</el-form-item>
					<!--二维码横向距离-->
					<el-form-item label="二维码横向距离">
						<el-slider class="max-w460" v-model="form.qrcode.left" :max="375" size="small" show-input :show-input-controls="false" input-size="small"></el-slider>
					</el-form-item>
					<!--二维码纵向距离-->
					<el-form-item label="二维码纵向距离">
						<el-slider class="max-w460" v-model="form.qrcode.top" :max="667" size="small" show-input :show-input-controls="false" input-size="small"></el-slider>
					</el-form-item>
