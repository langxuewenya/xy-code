      ...
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column fixed="right" label="操作" width="90">
            <template  #default="scope">
              <el-button v-if="scope.row.audit_status==0" @click="editClick(scope.row)" type="text" size="small" v-auth="'/audit/train/edit'">
                审核
              </el-button>
              <el-button v-if="scope.row.audit_status!=0" @click="detailClick(scope.row)" type="text" size="small" v-auth="'/audit/train/edit'">
                详情</el-button>
            </template>
          </el-table-column>
        </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        self.loading = true;
        AuditApi.trainList(Params, true)
          .then(data => {
            self.loading = false;
