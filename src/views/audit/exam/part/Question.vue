<template>
  ...
  <div>
    ...
    <Question :isDisabled='true' :questionType="questionType" :isquestion="isquestion" :islist="true" :currentList="currentList"
...
<script>
  ...
  export default {
    ...
    methods: {
      addFunct(n) {
        if(n == 1){
          this.currentList = this.form.model.single;
        }else if(n == 2){
          this.currentList = this.form.model.many;
        }else if(n == 3){
          this.currentList = this.form.model.judge;
        }
        this.questionType = n;
