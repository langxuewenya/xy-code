		...
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				...
				<el-form-item label="评价类型">
					<el-select size="small" v-model="searchForm.course_type" placeholder="">
						<el-option label="全部" :value="0"></el-option>
		...
		<div class="product-content">
			<div class="table-wrap">
				...
				<el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
					...
					<el-table-column prop="course_type" label="评价类型">
						<template #default="scope">
							<span v-if="scope.row.course_type==1" class="green">课程</span>
							<span v-if="scope.row.course_type==2" class="red">教务</span>
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作" width="120">
						<template #default="scope">
							<el-button @click="detailClick(scope.row)" type="text" size="small"
								v-auth="'/comment/comment/detail'">详情
							</el-button>
							<el-button @click="delClick(scope.row)" type="text" size="small"
								v-auth="'/comment/comment/delete'">删除
							</el-button>
						</template>
					</el-table-column>
				</el-table>
	...
	export default {
		...
		methods: {
			...
			getData(param = '') {
				...
				CommentApi.getCommentList(Params, true).then(res => {
					self.loading = false;
			...
			onSubmit() {
				...
				Params.page = self.curPage;
				Params.list_rows = self.pageSize;
				CommentApi.getCommentList(Params, true).then(data => {
					self.loading = false;
