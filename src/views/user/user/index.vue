		...
		<div class="product-content">
			<div class="table-wrap">
				<el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
					...
					<el-table-column prop="is_member" label="会员">
						<template #default="scope">
							<span v-if="scope.row.is_member==1" class="red">会员</span>
							<span v-else>非会员</span>
						</template>
					</el-table-column>
					<el-table-column prop="expire_time_text" label="会员有效期">
						<template #default="scope">
							<span class="red">{{scope.row.expire_time_text}}</span>
						</template>
					</el-table-column>
