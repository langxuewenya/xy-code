<template>
	...
	<div class="pb50 plan-setiting">
		<el-tabs v-model="activeName" @tab-click="handleClick">
			<el-tab-pane label="普通支付" name="10"></el-tab-pane>
			<el-tab-pane label="苹果内购" name="20"></el-tab-pane>
		</el-tabs>
		<div class="d-s-s f-w">
			<div class="item d-c-c d-c mb16" v-for="(item, index) in planList" :key="index">
				...
				<div class="f14 gray9">
					类型：
					<span class="orange" v-if="item.iap == 10">普通支付</span>
					<span class="orange" v-if="item.iap == 20">苹果内购</span>
				</div>
				<div class="mt16">
					<span class="p-0-20"><el-link type="primary" @click="openEdit(item)">编辑</el-link></span>
					<span class="p-0-20"><el-link type="danger" @click="delClick(item)">删除</el-link></span>
				</div>
			</div>
		...
		<Add v-if="open_add" :open="open_add" @close="closeAdd"></Add>

		<Edit v-if="open_edit" :open="open_edit" @close="closeEdit" :curModel="curModel"></Edit>
	</div>
</template>
<script>
