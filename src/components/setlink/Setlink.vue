    ...
    <el-tabs type="border-card" v-model="activeName">
      ...
      <el-tab-pane label="文章" name="Article"><Article v-if="activeName == 'Article'" @changeData="activeDataFunc"></Article></el-tab-pane>
       <el-tab-pane label="课程" name="CourseIndex">
        <CourseIndex v-if="activeName == 'CourseIndex'" @changeData="activeDataFunc"></CourseIndex>
      </el-tab-pane>
       <el-tab-pane label="教务" name="EducationIndex">
        <EducationIndex v-if="activeName == 'EducationIndex'" @changeData="activeDataFunc"></EducationIndex>
      </el-tab-pane>
         <el-tab-pane label="讲师" name="LectureIndex">
        <LectureIndex v-if="activeName == 'LectureIndex'" @changeData="activeDataFunc"></LectureIndex>
      </el-tab-pane>
         <el-tab-pane label="真题" name="ExamIndex">
        <ExamIndex v-if="activeName == 'ExamIndex'" @changeData="activeDataFunc"></ExamIndex>
      </el-tab-pane>
	  <el-tab-pane label="练习" name="TrainIndex">
	  	<TrainIndex v-if="activeName == 'TrainIndex'" @changeData="activeDataFunc"></TrainIndex>
	  </el-tab-pane>
...
import ExamIndex from './part/Exams.vue';
