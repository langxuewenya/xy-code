<template>
	...
	<div class="marketing-box">
		<el-tabs v-model="activeTab">
			...
			<el-tab-pane label="真题" name="detail"></el-tab-pane>
		</el-tabs>
		...
		<div class="product-list" v-if="activeTab == 'detail'" v-loading="loading">
			...
			<div class="common-seach-wrap">
				<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
					...
					<el-form-item label="真题名称"><el-input size="small" v-model="searchForm.search"
							placeholder="请输入真题名称"></el-input></el-form-item>
					<el-form-item>
			...
			<div class="product-content">
				<div class="table-wrap setlink-product-table">
					<el-table size="small" :data="tableData" border style="width: 100%">
						<el-table-column prop="title" label="真题名称"></el-table-column>
						...
						<el-table-column prop="category.name" label="真题分类"></el-table-column>
		...
		methods: {
			...
			changeFunc(e) {
				...
				if (this.activeTab == 'type') {
					obj.name = e.name;
					obj.url = '/pages/examination/exam/list?paper_type=2&category_id=' + e.category_id;
					obj.type = '真题分类';
				}
				if (this.activeTab == 'detail') {
					obj.name = e.title;
					obj.url = '/pages/examination/exam/detail?paper_id=' + e.paper_id;
					obj.type = '真题详情';
				}
