<template>
	...
	<div class="marketing-box">
		<el-tabs v-model="activeTab">
			...
			<el-tab-pane label="讲师" name="detail"></el-tab-pane>
		</el-tabs>
		...
		<div class="product-list" v-if="activeTab == 'detail'" v-loading="loading">
			...
			<div class="common-seach-wrap">
				<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
					...
					<el-form-item label="讲师名称"><el-input size="small" v-model="searchForm.search"
							placeholder="请输入讲师名称"></el-input></el-form-item>
					<el-form-item>
		...
		methods: {
			...
			changeFunc(e) {
				...
				if (this.activeTab == 'type') {
					obj.name = e.name;
					obj.url = '/pages/lecturer/list?category_id=' + e.category_id;
					obj.type = '讲师分类';
				}
				if (this.activeTab == 'detail') {
					obj.name = e.title;
					obj.url = '/pages/knowledge/lecturer/detail?lecturer_id=' + e.lecturer_id;
					obj.type = '讲师详情';
				}
