<template>
	...
	<el-dialog title="选择试题" v-model="dialogVisible" @close="dialogFormVisible" :modal-append-to-body="true"
		...
		<div class="common-seach-wrap">
			<el-form :inline="true" size="small" :model="formInline" class="demo-form-inline">
				<el-form-item label="试题名称">
					<el-input placeholder="请输入试题名称" v-model="formInline.search"></el-input>
				</el-form-item>
				<!-- <el-form-item label="试题类型">
					<el-select v-model="formInline.question_type"
						placeholder="请选择试题类型" style="width: 100px;">
				...
				<el-form-item label="试题分类">
					<el-select v-model="formInline.category_id" placeholder="请选择试题分类">
	...
	export default {
		...
		methods: {
			...
			getData() {
				...
				DataApi.questionList(params, true)
					.then(res => {
						if (res.code == 1) {
							self.loading = false;
