...
let PlusApi = {
    ...
    editApplyStatus(data, errorback) {
        return request._post('/shop/plus.agent.apply/edit', data, errorback);
    },
    /*分销商列表*/
	...
	/*添加分销商*/
	agentUserAdd(data, errorback) {
	    return request._post('/shop/plus.agent.user/add', data, errorback);
	},
    /*查看下级用户*/
	...
	/*等级列表*/
	toEditCourse(data, errorback) {
	    return request._get('/shop/plus.agent.course/edit', data, errorback);
	},
	editCourse(data, errorback) {
	    return request._post('/shop/plus.agent.course/edit', data, errorback);
	},
	getList(data, errorback) {
	    return request._post('/shop/plus.agent.course/index', data, errorback);
	},
	setState(data, errorback) {
	    return request._post('/shop/plus.agent.course/state', data, errorback);
	},
}
