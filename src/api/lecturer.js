...
let LecturerApi = {
	...
	lecturerForbid(data, errorback) {
		return request._post('/shop/lecturer.lecturer/forbid', data, errorback);
	},
	/*评论列表*/
	...
	applyList(data, errorback) {
		return request._post('/shop/lecturer.apply/index', data, errorback);
	},
	/*获取讲师申请详情*/
	getLecturerApply(data, errorback) {
		return request._get('/shop/lecturer.apply/edit', data, errorback);
	},
	/*讲师申请审核*/
	editLecturerApply(data, errorback) {
		return request._post('/shop/lecturer.apply/edit', data, errorback);
	},
}
