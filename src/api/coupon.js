...
let CouponApi = {
  ...
  /*添加优惠券*/
  toaddCoupon(data, errorback) {
    return request._get('/shop/plus.coupon.coupon/add', data, errorback);
  },
  /*添加优惠券*/
  ...
  /*优惠券详情*/
  getEditCoupon(data, errorback) {
    return request._get('/shop/plus.coupon.coupon/edit', data, errorback);
  },
  /*修改优惠券*/
